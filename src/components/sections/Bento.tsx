...
function Bento() {
    return (
        <div className={"flex flex-col gap-16 px-56 py-32 bg-neutral-900"} id={"dark-layer"}>
            <div className={"flex flex-col gap-4"}>
                <p className={"text-6xl text-white/90 font-bold"}>Lorem ipsum dolor sit amet</p>
                <p className={"text-3xl text-gray-400"}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
            </div>
